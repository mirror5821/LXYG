 ...
 */
public class DevItemDecoration extends RecyclerView.ItemDecoration{
    ...
    public DevItemDecoration(Context context, int orientation) {
     ...
     * @return
     */
    public DevItemDecoration setMarginLeftDP(int dp) {
        leftMargin = dp;
        return this;
    }
     ...
     * @return
     */
    public DevItemDecoration setMarginRightDP(int dp) {
        this.rightMargit = dp;
        return this;
    }
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        final int left = parent.getPaddingLeft() + DpUtil.dip2px(parent.getContext(), leftMargin);
        final int right = parent.getWidth() - parent.getPaddingRight() - DpUtil.dip2px(parent.getContext(), rightMargit);
