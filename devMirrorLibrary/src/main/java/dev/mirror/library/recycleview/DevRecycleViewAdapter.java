...
public abstract class DevRecycleViewAdapter<T> extends RecyclerView.Adapter<DevRecycleViewHolder> {
     ...
     * @param itemLayoutId
     */
    protected DevRecycleViewAdapter(Context context, List<T> mDatas, int itemLayoutId) {
    ...
    private void onBindAdvanceViewHolder(DevRecycleViewHolder holder, int i) {
     ...
     * @return Holder对象
     */
    protected DevRecycleViewHolder onCreateAdvanceViewHolder(ViewGroup parent, int viewType) {
    ...
    class HeaderHolder extends DevRecycleViewHolder {
    ...
    class FooterHolder extends DevRecycleViewHolder {
