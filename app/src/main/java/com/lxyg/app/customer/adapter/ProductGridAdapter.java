...
public class ProductGridAdapter extends DevListBaseAdapter<Product> {
	...
	public ProductGridAdapter(Context context, List<Product> list,TextView tv) {
		super(context, list);
		mInflater = LayoutInflater.from(context);
		mList = list;
		mContext = context;
	...
	public View initView(int position, View convertView, ViewGroup parent) {
		...
		TextView kc = (TextView)ViewHolder.get(convertView, R.id.kc_num);

		final Product g = mList.get(position);

		kc.setText("剩余: "+g.getProduct_number());
