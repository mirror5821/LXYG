...
public class ProductForCategoryAdapter extends DevListBaseAdapter<Product> {
	...
	public ProductForCategoryAdapter(Context context, List<Product> list) {
		super(context, list);
	...
	public ProductForCategoryAdapter(Context context, List<Product> list, TextView tv) {
		super(context, list);
		mInflater = LayoutInflater.from(context);
		mList = list;
		mContext = context;
