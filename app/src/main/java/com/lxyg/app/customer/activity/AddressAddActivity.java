...
public class AddressAddActivity extends BaseActivity {
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.map:
			startActivityForResult(new Intent(AddressAddActivity.this,MapSelectActivity.class), MAP_REQUESTCODE);
			break;
	...
	private void sub(){
		...
		mBaseHttpClient.postData1(ADDRESS_ADD, jb, new AppAjaxCallback.onResultListener() {
			...
			public void onResult(String data, String msg) {
				...
				switch (mIntentId) {
				case 1:
					 i = new Intent(AddressAddActivity.this,OrderMakeActivity.class);
					break;
				case 2:
					i = new Intent(AddressAddActivity.this,AddressListActivity.class);
